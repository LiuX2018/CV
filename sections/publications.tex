...
\makerubrichead{Representative Publications}
...
% \printbibliography[heading={subbibliography},title={Recent Five Years \textnormal{(\textsuperscript{\#}Equal contributors)}},type=article]

\printbibliography[heading={subbibliography},title={\textnormal{(\textsuperscript{*}Equal contributors; \textsuperscript{$\dagger$}Corresponding authors)}},type=article]
