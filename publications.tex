...
% \printbibliography[heading={subbibliography},title={Rceent Five Years as the 1st Author \textnormal{(\textsuperscript{\#}Equal contributors)}},type=article]

\printbibliography[heading={subbibliography},title={The 1st Author \textnormal{(\textsuperscript{\#}Equal contributors)}},type=article]
