...
\addbibresource{sections/own-bib.bib}

\AtBeginBibliography{\setcounter{maxnames}{99}}

%% Specify your last name(s) and first name(s) (as given in the .bib) to automatically bold your own name in the publications list.
%% One caveat: You need to write \bibnamedelima where there's a space in your name for this to work properly; or write \bibnamedelimi if you use initials in the .bib
\mynames{Liu/Xin,Liu\textsuperscript{*}/Xin,Liu\textsuperscript{*,$\dagger$}/Xin,Liu\textsuperscript{$\dagger$}/Xin}
...
\leftheader{%
  {\LARGE\bfseries\sffamily LIU, XIN}

\bigskip
\begin{tabular}{ll}
  \hspace{-1em} {\faEnvelope[regular]}{\href{mailto:liuxin.optics@gmail.com}{\texttt{liuxin.optics@gmail.com}}} \hspace{2em} & {\faGraduationCap}{\href{https://scholar.google.com/citations?user=umJBbTwAAAAJ&hl=en}{\texttt{Google Scholar}}} \\
  \hspace{-1em} {\faGithub}{\href{https://github.com/LiuX2018}{\texttt{github.com/LiuX2018}}} \hspace{2em} & {\faGlobe}{\href{https://liux2018.github.io}{\texttt{liux2018.github.io}}}
\end{tabular}
  % You can use a tabular here if you want to line up the fields.
}
\rightheader{~}
\begin{fullonly}
\photo[r]{photos/photo_kaust}
\photoscale{0.13}
\end{fullonly}
...
\makerubric{sections/professional_services}

\makerubric{sections/talks}

\makerubric{sections/experience_teaching}

\makerubric{sections/patents}
